// Importado só como TIPO — `better-sqlite3` é carregado via require() dentro de
// extractD1Schema(), para não forçar essa dependência nativa em quem só usa o driver Postgres.
